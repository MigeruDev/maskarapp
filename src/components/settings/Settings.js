                        ...
                        <Grid container>
                            <Grid xs={12} md={12} container item justify="center" alignItems="center" space={0} className={classes.content_header}>
                                <Grid item md={12} xs={12} className={classNames(classes.item)}>
                                    <Avatar alt="user" src={Logo} className={classNames(classes.large)} />
                                </Grid>
                                <Grid item md={12} xs={12} className={classNames(classes.item)}>
                                    <MenuList>
                                        <MenuItem className={classes.item_setting}>
                                            <ListItemIcon className={classes.item_icon}>
                                                <SettingsVoiceIcon fontSize="small" />
                                            </ListItemIcon>
                                            <Typography variant="inherit">Activar comando de voz</Typography>
                                        </MenuItem>
                                        <MenuItem className={classes.item_setting}>
                                            <ListItemIcon className={classes.item_icon}>
                                                <AccessibleIcon fontSize="small" />
                                            </ListItemIcon>
                                            <Typography variant="inherit">Habilitar uso asistido</Typography>
                                        </MenuItem>
                                        <MenuItem className={classes.item_setting}>
                                            <ListItemIcon className={classes.item_icon}>
